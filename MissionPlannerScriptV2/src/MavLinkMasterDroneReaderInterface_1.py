...
import numpy as np
from multiprocessing import Process, Queue as ImpQueue
import threading
...
###################
    ...
    def evasion_strategy(self, data_array):
        ...
        #angles_body = np.radians([a for _, a in lidar_data])
        #print(angles_body)
        ...
        min_angle_body = angles_body[valid_indices][min_dist_index]
        ...
        if min_dist <= danger_distance:
            ...
            # Convert body-frame avoidance angle to world-frame
